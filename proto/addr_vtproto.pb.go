...
var vtprotoPool_Address = sync.Pool{
	New: func() interface{} {
		return &Address{}
	},
}

func (m *Address) ResetVT() {
	m.Reset()
}
func (m *Address) ReturnToVTPool() {
	if m != nil {
		m.ResetVT()
		vtprotoPool_Address.Put(m)
	}
}
func AddressFromVTPool() *Address {
	return vtprotoPool_Address.Get().(*Address)
}
